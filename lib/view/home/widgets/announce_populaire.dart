...
class AnnouncePopulaire extends StatefulWidget {
  AnnouncePopulaire({
    super.key,
  ...
  @override
  State<AnnouncePopulaire> createState() => _AnnounceRecommandeState();
}

class _AnnounceRecommandeState extends State<AnnouncePopulaire> {
  @override
            ...
            children: [
              SizedBox(
                ...
                child: ListView.separated(
                  separatorBuilder:
                      (context, index) => SizedBox(width: spacing),
            ...
            children: [
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  scrollDirection: Axis.horizontal,
                  itemCount: widget.homeController.trendingPosts.length,
                  itemBuilder: (context, index) {
                    final post = widget.homeController.trendingPosts[index];

                    final user =
                        widget.homeController.usersFortrendingPosts[post
                            .userId];
